...
console.log("if you got a big array let me search it")
for (var i = 0; i < pokemon.length; i++) {
    //console.log("to find out your types I gotta compare it \n")
    if (pokemon[i].types == "poison") {
console.log("put my string down\n")
        console.log(pokemon[i].name);
        console.log("split it\n")
        console.log(pokemon[i].name.split(""));
        console.log("and reverse it\n")
